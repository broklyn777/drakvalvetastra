...
- **Större tärningar** i tärningsfönstret: 150 px (förut 70 px), 128 px på telefon. Flera tärningar (Advantage, 2d6, kritiska träffar) radbryts i stället för att sticka ut. Stilen `.gemini-die` kommer från ChatGPT:s #4; bara storleken är ändrad.
...
- Lokal webbläsare: tärningsrutan mätte 150 px på dator och 128 px i 400 px bred vy; två tärningar (Advantage) får plats på en rad i 300 px utan överflöd.

...
- I kryptans båda stridsvägar börjar skelettet vid 50 ft med sin officiella kortbåge. **Hel pelare vid 10 ft** ger totalt skydd; en närstridshjälte kan ta skydd, tvinga skelettet att närma sig och sedan gå ut för att slå på 5 ft. **Sprucken pelare vid 25 ft** ger Half Cover (+2 AC mot skott) och en snabbare men öppnare väg fram. Skelettet drar sitt kortsvärd vid 5 ft. Dessa val finns som knappar i stridspanelen efter både försiktig framryckning och ropet i mörkret.
...
| Kryptan    | [Skeleton](https://www.dndbeyond.com/monsters/17015-skeleton) | 1/4 | AC 13, HP 13, Shortsword och Shortbow +4 (1T6+2), kortbåge 80/320 ft, sårbar för krosskada |
...
`npm test` kontrollerar de fyra vägarna in i värdshusstriden, faktisk attackräckvidd och vapenval, frontlinje samt officiella fiendeprofiler. Kryptans egna tester verifierar båda pelarna, skelettets vapenval, bruten sikt, förflyttning in i närstrid och sparning mitt i striden. `npm run typecheck`, `npm run build` och webbläsartesterna validerar klient, protokoll, server och synliga knappar.
